            ...
            <section class=" my-5 mx-auto">
                <form action={{ route('admin.tags.store') }} method="POST">
                    ...
                    <div class="form-check mt-3">
                        ...
                        <x-form.input type="text" id="tagname" class="form-control" name="name"></x-form.input>
                    </div>
                    <div class="form-check mt-3">
                        <x-form.label for="description" class="form-label">Description</x-form.label>
                        <x-form.textarea type="text" id="description" class="form-control" name="description"></x-form.textarea>
                    </div>
                    <div class="form-check mt-3">
                        <x-form.label for="meta_title" class="form-label"> Meta title</x-form.label>
                        <x-form.input type="text" id="meta_title" class="form-control" name="meta_title"></x-form.input>
                    </div>
                    <div class="form-check mt-3">
                        <x-form.label for="meta_description" class="form-label"> Meta Description</x-form.label>
                        <x-form.textarea type="text" id="meta_description" class="form-control" name="meta_description"></x-form.textarea>
                    </div>
